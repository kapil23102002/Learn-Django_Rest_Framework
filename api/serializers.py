...
# #------- Normal Serializer (automatically did not get all data in model) -------------
...
# -------- Model Serializer (automatically get all data  and CRUD method in model) -------------
class StudentSerializier(serializers.ModelSerializer):
    class Meta:
        model = Student
